...
exports.DeleteLiveService = void 0;
        ...
        return __awaiter(this, arguments, void 0, function* ({ id }) {
            ...
            try {
                ...
                if (error &&
                    error.code === "P2003") {
                    return {
                        message: "Não foi possível deletar a live. Verifique se ela não está vinculada a algum curso ou categoria.",
                        status: 400,
                    };
                }
...
exports.DeleteLiveService = DeleteLiveService;
//# sourceMappingURL=deleteLiveService.js.map